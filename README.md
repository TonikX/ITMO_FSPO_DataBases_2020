...
[Учебный журнал](https://docs.google.com/spreadsheets/d/1B1EQtvXEoXnrmgglrSsRrT6JfcqQMIcdLTkTr6-S0cM/edit?usp=sharing) по дисциплине. Тут доступна информация о сроках сдачи работ, о текущей успеваемости студентов и описаны все материалы необходимые для реализации курса.
...
[Практические работы](https://drive.google.com/open?id=1sUM8PVWfFH3-Cg_NFGrEplNCZx3cZV3r) - задания, которые необходимо выполнить перед выполнением лабораторной работы для того, чтобы освоить тему.
...
Отчет о практической части содержит PDF-файл с вашей функциональной моделью и высылается на antongovorov@gmail.com. Шаблон темы письма "ИТМО ФСПО Номер_группы Практическая работа ФИО". Пример: "ИТМО ФСПО К3340 Практическая работа №1 Филимонов Филипп Филиппович". 
...
Полученный SQL код и ответ залить в папку этого репозитория **sutdents/группа/laboratory_works/фамилия_имя/laboratory_work_3**. Инструкция о загрузке работы ниже. Не забывайте о файле гитигнор.
На гит должен быть загружен пдф файл с отчетом, sql файл с базой. Для каждой таблицы в sql файле должен быть написан комментарий с ее описанием. Как делать пул реквест описано в разделе **Сдача работ**

## Лабораторная работа №4

Необходимо реализовать некоторое количество SQL-запросов. В качестве лабораторной работы №4 Вам требуется написать запросов на определенное количество баллов, зависимое от оценки, на которую Вы претендуете.       .
