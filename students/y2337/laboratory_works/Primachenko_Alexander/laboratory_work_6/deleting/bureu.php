...
<html>
	...
	<h2>Удалить запись из таблицы Бюро Брокеров</h2>
    ...
    <form name="insert" action="bureu.php" method="POST">
    ...
    <?php
        ...
        if($_POST != NULL)
        {
            if($result = pg_delete($db, 'BrokersBureu', $_POST))
		...
		$query = 'select * from public."BrokersBureu" order by id asc';
